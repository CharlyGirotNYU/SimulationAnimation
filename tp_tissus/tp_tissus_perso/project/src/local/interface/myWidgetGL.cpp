...
void myWidgetGL::change_K_structural(int v)
{
    scene_3d.set_K_structural(v);
}
void myWidgetGL::change_K_shearing(int v)
{
    scene_3d.set_K_shearing(v);
}
void myWidgetGL::change_K_bending(int v)
{
    scene_3d.set_K_bending(v);
}

void myWidgetGL::change_wind(int v)
{
    scene_3d.set_wind(v);
}

void myWidgetGL::change_dt(int v)
{
    scene_3d.set_dt(v);
}
